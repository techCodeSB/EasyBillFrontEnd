          ...
          </div>
          {
            !loading ? billData.length > 0 ? <div className='content__body__main'>
              ...
              {/* <div className='flex justify-between items-center flex-col lg:flex-row gap-4'>
                <div className='flex items-center gap-4 justify-between w-full lg:justify-start'>
                  ...
                  <div className='list__icons'>
                    <div className='list__icon' data-tooltip-id="debitTooltip" data-tooltip-content="Print"
                      onClick={() => exportTable('print')}>
                      <BiPrinter className='text-white text-[16px]' />
                    </div>
                    <div className='list__icon' data-tooltip-id="debitTooltip" data-tooltip-content="Copy Table"
                      onClick={() => exportTable('copy')}>
                      <FaRegCopy className='text-white text-[16px]' />
                    </div>
                    <div className='list__icon' data-tooltip-id="debitTooltip" data-tooltip-content="Download PDF"
                      onClick={() => exportTable('pdf')}>
                      <FaRegFilePdf className='text-white text-[16px]' />
                    </div>
                    <div className='list__icon' data-tooltip-id="debitTooltip" data-tooltip-content="Download Excel"
              ...
              {/* <div className='list_buttons'>
                <button className='bg-teal-500 hover:bg-teal-400' onClick={() => navigate('/admin/debit-note/add')}>
                  ...
                  <tbody>
                    {
                      billData.map((data, i) => {
                        return <tr key={i}>
                          ...
                          <td className='px-4 border-b' align='center'>{data.debitNoteDate}</td>
                          ...
                          <td className='px-4 border-b max-w-[70px]' align='center'>
                            <div className='flex flex-col md:flex-row gap-2 mr-2 justify-center'>
                              <button
                                data-tooltip-id="debitTooltip" data-tooltip-content="Edit"
                                onClick={() => navigate(`/admin/debit-note/edit/${data._id}`)}
                                className='bg-blue-400 text-white px-2 flex justify-center py-1 rounded w-[40px] text-[16px]'>
                                <MdEditSquare />
                              </button>
                              <button
                                data-tooltip-id="debitTooltip" data-tooltip-content="Details"
