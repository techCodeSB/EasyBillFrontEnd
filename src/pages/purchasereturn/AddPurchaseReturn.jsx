...
const PurchaseInvoice = ({ mode }) => {
  ...
  */
  ...
  const saveBill = async () => {
    ...
    if ([formData.party, formData.purchaseReturnNumber, formData.returnData, formData.validDate]
      .some((field) => field === "")) {
    ...
    try {
      ...
      clearForm();
      return toast('Purchase Return add successfully', 'success');
          ...
          <div className='content__body__main bg-white' id='addQuotationTable'>
            <div className='flex flex-col lg:flex-row items-center justify-around gap-4'>
              ...
              <div className='flex flex-col gap-2 w-full lg:w-1/3'>
                <p className='text-xs'>Purchase Return Number</p>
                <input type="text"
